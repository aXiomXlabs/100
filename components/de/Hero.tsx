  ...
  return (
    ...
    >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col items-start text-left">
            ...
            <motion.h1
              ...
              itemProp="headline"
            >
              Dominiere Solana Meme Coins mit <span className="text-gradient font-extrabold">Rust Rocket</span>
            </motion.h1>
            ...
            >
              Der #1 Solana Sniper Bot mit Same-Block Execution und intelligentem Copy Trading. Perfekt für pump.fun
              Sniping und professionelles Solana-Trading.
            </motion.p>
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <span className="text-text-primary font-medium">Same-Block Ausführung</span>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <span className="text-text-primary font-medium">Solana Optimiert</span>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-xs text-text-secondary">Ausführungsgeschwindigkeit</div>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-xs text-text-secondary">Erfolgsrate</div>
      ...
      <div
        ...
        aria-hidden="true"
      >
        <span className="text-text-secondary text-sm mb-2">Scrolle um mehr zu entdecken</span>
