      ...
      <footer className="py-6 bg-gray-900">
        <div className="container px-4 mx-auto">
          <div className="flex flex-col items-center justify-between space-y-4 md:flex-row md:space-y-0">
            <div className="text-sm text-gray-500">© {new Date().getFullYear()} Rust Rocket. All rights reserved.</div>
            <div className="flex space-x-4">
              <a href="/privacy" className="text-sm text-gray-500 hover:text-primary">
                Privacy
              </a>
              <a href="/terms" className="text-sm text-gray-500 hover:text-primary">
                Terms
              </a>
            </div>
          </div>
