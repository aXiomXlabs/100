...
export const metadata: Metadata = {
  title: "Rust Rocket | 25ms Solana Sniper Bot with Pro Copy Trading & Automated DeFi Trading",
  description:
    "Dominate Solana meme coins with Rust Rocket - the fastest same-block execution bot with intelligent copy trading. Perfect for Pump.fun sniping and automated DeFi trading.",
  generator: "Next.js",
  ...
  openGraph: {
    title: "Rust Rocket | 25ms Solana Sniper Bot with Pro Copy Trading & Automated DeFi Trading",
    description:
      "Dominate Solana meme coins with Rust Rocket - the fastest same-block execution bot with intelligent copy trading and automated DeFi trading.",
  ...
  return (
    <html lang="en" className={inter.variable} itemScope itemType="http://schema.org/WebPage">
      <head>
        ...
        {/* Google Tag Manager - Must be placed before other tracking scripts */}
        <Script
          id="gtm-script"
        ...
        <Script id="google-analytics" strategy="afterInteractive">
          ...
          // Consent Mode - Must be before gtag('config')
        ...
        <Script id="facebook-pixel" strategy="afterInteractive">
          ...
          // Enhanced Conversions for Facebook
